...
const PopularProperty = () => {
	return (
		<div className="bg-[#222222] px-3 md:px-12 lg:px-16 pb-14 pt-20">
			{/* heading */}
			...
			>
				...
				<SwiperSlide>
					<div className="w-[310px] overflow-hidden  md:w-[300px] xl:w-[380px] mb-20 bg-[#ffffff]">
						...
						<div className="p-6">
							<h1 className="text-[#aa8453] font-sen font-bold text-[21px]">$1850 <span className="text-[14px] text-[#6d7175]">(monthly)</span></h1>
							<p className="text-[#12171f] font-sen text-lg font-medium py-1">Luxury Condos Reverside</p>
							{/* location div */}
							<div className="flex text-[#6d7175] text-[14px]  items-center font-barlow">
								<MdLocationPin className="text-[#aa8453]" />
								<p>4213 South Burlingtion, VT 05403</p>
				...
				<SwiperSlide>
					<div className="w-[310px] overflow-hidden  md:w-[300px] xl:w-[380px] mb-20 bg-[#ffffff]">
						...
						<div className="p-6">
							<h1 className="text-[#aa8453] font-sen font-bold text-[21px]">$1850 <span className="text-[14px] text-[#6d7175]">(monthly)</span></h1>
							<p className="text-[#12171f] font-sen text-lg font-medium py-1">Gorgeous Villa Bay View</p>
							{/* location div */}
							<div className="flex text-[#6d7175] text-[14px]  items-center font-barlow">
								<MdLocationPin className="text-[#aa8453]" />
								<p>4213 South Burlingtion, VT 05403</p>
				...
				<SwiperSlide>
					<div className="w-[310px] overflow-hidden  md:w-[300px] xl:w-[380px] mb-20 bg-[#ffffff]">
						...
						<div className="p-6">
							<h1 className="text-[#aa8453] font-sen font-bold text-[21px]">$1850 <span className="text-[14px] text-[#6d7175]">(monthly)</span></h1>
							<p className="text-[#12171f] font-sen text-lg font-medium py-1">New Develop Condos</p>
							{/* location div */}
							<div className="flex text-[#6d7175] text-[14px]  items-center font-barlow">
								<MdLocationPin className="text-[#aa8453]" />
								<p>4213 South Burlingtion, VT 05403</p>
				...
				<SwiperSlide>
					<div className="w-[310px] overflow-hidden  md:w-[300px] xl:w-[380px] mb-20 bg-[#ffffff]">
						...
						<div className="p-6">
							<h1 className="text-[#aa8453] font-sen font-bold text-[21px]">$1850 <span className="text-[14px] text-[#6d7175]">(monthly)</span></h1>
							<p className="text-[#12171f] font-sen text-lg font-medium py-1">Luxury Condos</p>
							{/* location div */}
							<div className="flex text-[#6d7175] text-[14px]  items-center font-barlow">
								<MdLocationPin className="text-[#aa8453]" />
								<p>4213 South Burlingtion, VT 05403</p>
